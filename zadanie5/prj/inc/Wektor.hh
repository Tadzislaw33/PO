...
class Wektor {
     ...
     */
    Typ Wsp[Rozmiar];
    static void ZwiekszLicznikObiektow() { ++LicznikObiektow; }
    static void ZwiekszLicznikAktywnychObiektow() { ++LicznikAktywnychObiektow; }
    static void ZmniejszLicznikAktywnychObiektow() { --LicznikAktywnychObiektow; }

  public:

    static unsigned int LicznikObiektow;
    static unsigned int LicznikAktywnychObiektow;
    static int WezWartoscAktywnegoLicznikaObiektow() { return LicznikAktywnychObiektow; } 
    static int WezWartoscLicznikaObiektow() { return LicznikObiektow; }
...
template <typename Typ, int Rozmiar>
unsigned int Wektor<Typ,Rozmiar>::LicznikObiektow = 0;


template <typename Typ, int Rozmiar>
unsigned int Wektor<Typ,Rozmiar>::LicznikAktywnychObiektow = 0;
...
Wektor<Typ,Rozmiar>::Wektor()
{
  ...
  ZwiekszLicznikObiektow();
  ZwiekszLicznikAktywnychObiektow(); 
}

template <typename Typ, int Rozmiar>
Wektor<Typ,Rozmiar>::~Wektor<Typ,Rozmiar>()
{
  ZmniejszLicznikAktywnychObiektow();
}
